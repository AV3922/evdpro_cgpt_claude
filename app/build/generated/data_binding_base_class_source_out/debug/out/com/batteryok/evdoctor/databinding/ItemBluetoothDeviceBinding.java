...
public final class ItemBluetoothDeviceBinding implements ViewBinding {
  ...
  private ItemBluetoothDeviceBinding(@NonNull LinearLayout rootView,
      @NonNull ImageView ivConnectStatus, @NonNull TextView tvDeviceAddress,
      @NonNull TextView tvDeviceName) {
    this.rootView = rootView;
    this.ivConnectStatus = ivConnectStatus;
  ...
  public static ItemBluetoothDeviceBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.ivConnectStatus;
      ImageView ivConnectStatus = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemBluetoothDeviceBinding((LinearLayout) rootView, ivConnectStatus,
